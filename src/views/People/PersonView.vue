          ...
          tbody
            tr.odd_bg-gray-50.even_bg-white
              ...
              td.py-4
                ...
                template(v-else-if="!!person.dateOfBirth") {{ $filters.humanDate(person.dateOfBirth) }} ({{ $filters.durationInYearsOrMonths(person.dateOfBirth) }} old)
            tr.odd_bg-gray-50.even_bg-white
            ...
            tr.odd_bg-gray-50.even_bg-white
              ...
              td.py-4
                ...
                template(v-else) {{ person?.mobileNumber }}
            tr.odd_bg-gray-50.even_bg-white
            ...
            tr.odd_bg-gray-50.even_bg-white
              ...
              td.py-4
                ...
                template(v-else-if="!!person.registeredDate") {{ $filters.fullDateTime(person.registeredDate) }} ({{ $filters.humanize(person.registeredDate) }} ago)
